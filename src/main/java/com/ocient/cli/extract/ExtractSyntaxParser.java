...
public class ExtractSyntaxParser
{
    ...
    */
    ...
    private static Properties parseOptions(String ops) throws ParseException
    {
        ...
        List<String> tokens = stringTokenizer(ops);
     ...
     * @return List<String> seperated key=value pairs.
     * @throws ParseException
     */

    private static List<String> stringTokenizer(String options) throws ParseException{
        
        List<String> tokens = new ArrayList<String>();
        final StringBuilder runningString = new StringBuilder();
